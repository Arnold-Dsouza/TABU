...
export default function TeaRoom() {
    const { isAdmin, userApartment } = useAdminAccess('teaRoom');
             ...
             <Card className="w-full max-w-2xl shadow-lg relative">
                ...
                <CardHeader className="text-center bg-muted/30">
                    <div className="flex justify-center items-center gap-3 mb-2">
                        <Coffee className="h-8 md:h-10 w-8 md:w-10 text-primary" />
                        <CardTitle className="text-2xl md:text-3xl font-bold font-headline tracking-tight">Tea Room</CardTitle>
                    </div>
            ...
            <Card className="w-full max-w-4xl shadow-lg">
                <CardHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <CardTitle className="text-xl md:text-2xl font-bold font-headline">Menu of the Day</CardTitle>
                    </div>
                ...
                <CardContent>
                    <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                        <div>
                            <h3 className="text-lg md:text-xl font-bold mb-4 text-center text-white bg-primary/80 rounded-md py-2">SPECIALS</h3>
                        ...
                        <div>
                            <h3 className="text-lg md:text-xl font-bold mb-4 text-center text-white bg-primary/80 rounded-md py-2">REGULARS</h3>
            ...
            <Card className="w-full max-w-2xl shadow-lg">
                ...
                <CardContent>
                    <p className="text-center text-muted-foreground p-2 md:p-4 text-sm md:text-base">
                        To rent the tea room for a private party, please contact {content.privatePartiesContact || 'us'}.
                    </p>
                </CardContent>
            </Card>
        </div>
