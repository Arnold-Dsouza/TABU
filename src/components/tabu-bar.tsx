    ...
    return (
        <div className="flex flex-col items-center justify-start p-4 md:p-8 gap-8 w-full">
                 ...
                 {isAdmin && (
                    <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
                        ...
                        <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
                            <DialogHeader><DialogTitle>Edit Tabu Bar Details</DialogTitle></DialogHeader>
            ...
            <Card className="w-full max-w-2xl shadow-lg">
                ...
                <CardContent><p className="text-center text-muted-foreground">To rent the bar for a private party, please contact {content.privatePartiesContact || 'XYZ'}.</p></CardContent>
            </Card>
        </div>
    );
}

function TabuBarSkeleton() {
     return (
        <div className="flex flex-col items-center justify-start p-4 md:p-8 gap-8 w-full">
            <Card className="w-full max-w-2xl shadow-lg"><CardHeader className="text-center bg-muted/30"><div className="flex justify-center items-center gap-3 mb-2"><Martini className="h-10 w-10 text-primary" /><CardTitle className="text-3xl font-bold font-headline tracking-tight">Tabu Bar</CardTitle></div><CardDescription className="text-lg">Opening Hours</CardDescription></CardHeader><CardContent className="p-6"><div className="space-y-4"><Skeleton className="h-16 w-full" /></div></CardContent></Card>
            <Separator className="my-4 w-full max-w-2xl" />
            ...
            <Card className="w-full max-w-2xl shadow-lg"><CardHeader><Skeleton className="h-8 w-48" /></CardHeader><CardContent className="space-y-3"><Skeleton className="h-8 w-full" /></CardContent></Card>
            <Card className="w-full max-w-2xl shadow-lg"><CardHeader><Skeleton className="h-8 w-48" /></CardHeader><CardContent><Skeleton className="h-6 w-3/4 mx-auto" /></CardContent></Card>
        </div>
    );
}
