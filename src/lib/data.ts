...
export const initialBuildingsData: Building[] = [
  {
    ...
    machines: [
      ...
      { id: 'w2-58', name: 'Washer 2', type: 'washer', status: 'in-use', timerEnd: 2700000, apartmentUser: 'Apt 101', reports: [], warnings: [] },
  ...
  },
  {
    ...
    machines: [
      ...
      { id: 'd1-60', name: 'Dryer 1', type: 'dryer', status: 'in-use', timerEnd: 1800000, apartmentUser: 'Apt 204', reports: [], warnings: [] },
    ],
  },
  {
    id: 'bldg-62',
    name: 'Building 62',
    machines: [
      { id: 'w1-62', name: 'Washer 1', type: 'washer', status: 'in-use', timerEnd: 600000, apartmentUser: 'Apt 302', reports: [], warnings: [] },
